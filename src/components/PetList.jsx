...
export default function PetList({ petData }) {
  return (
    <>
      ...
      <div className="p-3 sm:p-2 gap-2 mb-2 mx-auto rounded-md md:max-h-screen overflow-x-auto w-fit sm:max-h-80 col-span-1 border-2 border-purple-400 scroll-pl-6">
        <h1 className="text-center text-yellow-400 font-bold p-2 border-b-2 ">
          POKEMONS:
        </h1>
        <div className="mb-50 p-2 flex flex-wrap mx-auto">
          {petData.map((pet) => (
